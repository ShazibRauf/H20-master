...
def select_model(model_def, depth, features3d):
    if model_def.lower() == 'hopenet':
        model = HopeNet(generate_hand_mesh=False, generate_obj_mesh=False, generate_mesh=True, depth=depth, features3d=features3d)
